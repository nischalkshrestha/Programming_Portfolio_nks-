...
labgroup = 24
students_data = int(input("How many students? : "))
groupsize = int(input("Required Group Size? : "))
groups = students_data // groupsize
students = students_data % groupsize
print("There will be",groups,"groups with",students,"student left over.")
